...
class BajaController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('baja_show', array('idejemplar' => $baja->getIdejemplar()));
        }
     ...
     *
     * @Route("/{idejemplar}", name="baja_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{idejemplar}/edit", name="baja_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Baja $baja)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('baja_edit', array('idejemplar' => $baja->getIdejemplar()));
        }
     ...
     *
     * @Route("/{idejemplar}", name="baja_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Baja $baja)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('baja_delete', array('idejemplar' => $baja->getIdejemplar())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
